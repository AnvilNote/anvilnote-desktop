...
export function config() {
  ...
  return {
    ...
    aiWriterDir: resolveDir(e.ANVILNOTE_AI_WRITER_DIR ?? "../anvilnote-ai-writer"),
    ...
    funcsDir: resolveDir(e.ANVILNOTE_FUNCS_DIR ?? "../anvilnote-funcs"),
    webDist: e.ANVILNOTE_WEB_DIST ?? "dist",
    apiDist: e.ANVILNOTE_API_DIST ?? "dist",
    aiWriterDist: e.ANVILNOTE_AI_WRITER_DIST ?? "dist",
    ...
    funcsDist: e.ANVILNOTE_FUNCS_DIST ?? "dist",
